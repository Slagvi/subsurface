				...
				* If current gas is hypoxic, we want to switch asap */
				if (current_cylinder != gaschanges[gi].gasidx) {
					if (!prefs.switch_at_req_stop ||
							...
							&displayed_dive.cylinder[current_cylinder].gasmix, po2, diveplan->surface_pressure / 1000.0, is_vpmb) || get_o2(&displayed_dive.cylinder[current_cylinder].gasmix) < 160) {
